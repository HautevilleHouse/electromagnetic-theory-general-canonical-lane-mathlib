...
def mathlibProofObligation : MathlibProofObligation := {
  sourceKey := "electromagnetic-theory-general",
  theoremObject := "Maxwell's equations and gauge invariance",
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedElectromagneticClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_electromagnetic_endgame A
